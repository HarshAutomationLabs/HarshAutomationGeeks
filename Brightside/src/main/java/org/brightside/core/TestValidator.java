...
public class TestValidator extends WebConnector {
	...
	// TestUtils.copyFile(scrFile, new File(currentDir + "/screenshots/" +
	...
	public static boolean checkValueAttribute(WebElement chatMessageField) {
		if (chatMessageField.getAttribute("Value").isEmpty()) {
			return false;
		} else {
			return true;
		}
